...
public class Constantes {
	...
	public static final String APP_SECRET_KEY = "dswkey";
	public static final String APP_CONFIG_CLIENTE = "clientedsw";
	public static final String APP_CLIENT_PASSWORD = "dsw";
